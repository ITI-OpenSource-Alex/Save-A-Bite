...
router.post(
  ...
  AuthorizeRoles(categoryPolicy.canCreate),
  ValidationMiddleware(CategoryDto),
  categoryController.createCategory
);
router.get("/list", categoryController.list);
router.get("/details/:id", AuthorizeRoles(categoryPolicy.canRead), categoryController.details);
router.put(
  "/update/:id",
  IsAuthenticatedMiddleware,
  AuthorizeRoles(categoryPolicy.canUpdate),
  categoryController.update
);
router.delete(
  "/delete/:id",
  IsAuthenticatedMiddleware,
  AuthorizeRoles(categoryPolicy.canDelete),
