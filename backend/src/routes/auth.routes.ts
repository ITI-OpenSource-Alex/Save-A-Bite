...
router.get('/verify-email',ValidationMiddleware(VerifyEmailDto, 'query'),authController.verifyEmail);
...
router.put('/update-profile', IsAuthenticatedMiddleware, ValidationMiddleware(UpdateProfileDto), authController.updateProfile);
