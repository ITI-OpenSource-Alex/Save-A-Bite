...
export class AddressController {
    ...
    addAddress = async (req: AuthRequest, res: ExpressResponse, next: NextFunction): Promise<void> => {
        try {
    ...
    getMyAddresses = async (req: AuthRequest, res: ExpressResponse, next: NextFunction): Promise<void> => {
        try {
            const userId = req.jwt?.userId;
            if (!userId) {
    ...
    updateAddress = async (req: AuthRequest, res: ExpressResponse, next: NextFunction): Promise<void> => {
        try {
    ...
    deleteAddress = async (req: AuthRequest, res: ExpressResponse, next: NextFunction): Promise<void> => {
        try {
            const { id } = req.params as { id: string };
